...
INSERT INTO `astronomicaltype` VALUES (01,'astre'), (02,'planète morte'),(03, 'planète'), (04,'comète'), (05,'lune vagabonde'), (06,'lune d\'atrebois'), (07,'lune de cravite'), (08, 'laboratoire de recherches nomai'), (09, 'relique nomai'), (10, 'origine du big bang');
--
...
INSERT INTO `astronomicalbody` VALUES (014,'Atrebois',911,03,'tempéré',1,_binary '',NULL),(001,'Cravité',411,01,'chaotique',2,_binary '\0','9975-05-05'),(002,'Sombronce',414,02,NULL,NULL,_binary '',NULL),(003,'Leviante',413,03,'tempête',3,_binary '','9980-01-01'),(004,'Sablières',912,03,'aride',1,_binary '\0',NULL),(005,'L\'intrus',910,04,'glacé',NULL,_binary '','8764-01-01'),(006,'Lune quantique',NULL,05,'quantique',1,_binary '\0',NULL),(007,'Rocaille',410,06,NULL,1,_binary '\0','9955-02-05'),(008,'la Lanterne',NULL,07,'volcanique',3,_binary '\0',NULL),(009,'la station solaire',510,08,'torride',1,_binary '\0','9999-12-31'),(010,'le canon orbital',510,09,NULL,NULL,_binary '\0','9999-12-31'),(011,'Station du trou blanc',510,09,NULL,NULL,_binary '\0','9999-12-31'),(012,'l oeil de l univers',510,10,'quantique',NULL,_binary '\0','9999-12-31'),(013,'le Soleil',NULL,01,NULL,100,_binary '\0',NULL), (015,'Pluton',913,10,'tempéré', 54,_binary '', '4567-04-14'), (016, 'Mars', 910, 5, 'aride', 66, _binary '', '3333-07-04'), (017, 'Saturne',912, 3, 'torride', 12, _binary '\0', '7777-11-01'), (018, 'Akilian', NULL, 5, 'glacé', 99, _binary '\0', '5555-09-30'), (019, 'Asgard', 913, 10, 'quantique', 87, _binary '', '8888-01-16'),(020, 'Tatooine', 912, 4, 'tempéré', 44, _binary '', '2222-02-22');
...
INSERT INTO `colony` VALUES ('Arena monstrum',20,'Ere des explorateurs',NULL),('Arena monstrum',20,'Ere préhistorique',NULL),('Coelacanthiformes gigantis',2,'Ere des explorateurs','le nid'),('Coelacanthiformes gigantis',2,'Ere des pélerins','le nid'),('Coelacanthiformes gigantis',2,'Ere du grand chaudron cosmique','le nid'),('Coelacanthiformes gigantis',2,'Ere préhistorique','le nid'),('Coelacanthiformes gigantis',5,'Ere du grand chaudron cosmique','la ruche'),('Genios ex astris',8,'Ere des pélerins','la mine'),('Genios ex astris',15,'Ere des pélerins','la cité suspendue'),('Genios ex astris',11,'Ere des pélerins','le laboratoire des hautes énergies'),('Genios ex astris',5,'Ere des pélerins','la cité enfouie'),('Octopode pacificae',5,'Ere des pélerins','Empire octogonal'),('Octopode pacificae',5,'Ere du grand chaudron cosmique','Royaume des minimoys'),('Periculosum mollis',8,'Ere des explorateurs',NULL),('Periculosum mollis',7,'Ere préhistorique',NULL),('Quattuor luscus Arnoldus',8,'Ere des explorateurs','le village'),('Quattuor luscus Arnoldus',7,'Ere des explorateurs','le laboratoire de recherche antiques'),('Quattuor luscus Arnoldus',9,'Ere des explorateurs','l observatoire'),('Quattuor luscus tadpoles',8,'Ere des pélerins',NULL),('Quattuor luscus tadpoles',8,'Ere préhistorique','Royaume des schtroumpfs'),('Silens mortem',8,'Ere des explorateurs','la cité 44'),('Silens mortem',8,'Ere préhistorique',NULL),('Silens mortem',10,'Ere des explorateurs','Zone 59'),('Silens mortem',10,'Ere préhistorique','le Zoo'),('Silens mortem',6,'Ere des explorateurs',NULL),('Silens mortem',6,'Ere des pélerins','Cité 55'),('Silens mortem',3,'Ere préhistorique',NULL);
